...
const aspectRatio = atomWithLocalStorage<string>('aspectRatio', 'Auto');
const style = atomWithLocalStorage<[string, string] | null>('style', null);

const imageModel = atomWithLocalStorage<string>('imageModel', 'fal-ai/imagen4/preview/fast');
